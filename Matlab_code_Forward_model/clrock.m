function [P_cosmo,P_rad] = clrock(sample,e,Lambda_e,so_e,EL_f,EL_mu,Psi_Cl36_Ca_0,rho_rock,Param_LSD, flag)
...
elseif(strcmp(flag.mu_model,'lsd'))
   ...
   P_sp = mean( (P_sp_Ca + P_sp_K + P_sp_Ti + P_sp_Fe).*exp(-depths./Lambda_e) );
...
elseif(strcmp(flag.mu_model,'lsd'))
    ...
    phi_eth_total = mean((phi_star_eth .* exp(-depths./Lambda_e) + ...
...
elseif(strcmp(flag.mu_model,'lsd'))
    ...
    phi_th_total = mean(phi_star_th.*exp(-depths./Lambda_e) + ...
