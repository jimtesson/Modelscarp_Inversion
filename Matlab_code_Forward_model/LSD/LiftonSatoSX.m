...
[nflux,P3n,P10n,P14n,P26n,P36Can,P36Kn,P36Tin,P36Fen] = Neutrons(Href,Rcref,Sref,w,consts);
%[ethflux,thflux] = NeutronsLowE(Href,Rcref,Sref,w)
[ethflux,thflux] = NeutronsLowE_crep(Href,Rcref,Sref,w);
%[pflux,P3p,P10p,P14p,P26p,P36Cap,P36Kp,P36Tip,P36Fep] = ProtonsXS(Href,Rcref,Sref,consts)
[pflux,P3p,P10p,P14p,P26p,P36Cap,P36Kp,P36Tip,P36Fep] = Protons(Href,Rcref,Sref,consts);
SpRef = nflux + pflux;% Sato et al. (2008) Reference hadron flux integral >1 MeV
HeRef = P3n + P3p;
BeRef = P10n + P10p;
CRef = P14n + P14p;
...
%[nflux,P3n,P10n,P14n,P26n,P36Can,P36Kn,P36Tin,P36Fen] = Neutrons(h,Rc,SPhi,w,consts);

[ethflux,thflux] = NeutronsLowE(h,Rc,SPhi,w);
%[ethflux,thflux] = NeutronsLowE_crep(h,Rc,SPhi,w);
[pflux,P3p,P10p,P14p,P26p,P36Cap,P36Kp,P36Tip,P36Fep] = ProtonsXS(h,Rc,SPhi,consts);
%[pflux,P3p,P10p,P14p,P26p,P36Cap,P36Kp,P36Tip,P36Fep] = Protons(h,Rc,SPhi,consts)
